...
@section('title', 'Edit Pricing — Admin')
    ...
    <form method="POST" action="{{ route('admin.pricing-plans.update', $plan) }}">
        ...
        <div class="form-grid">
            ...
            <div class="field">
                ...
                <input type="text" name="cta_label" value="{{ old('cta_label', $plan->cta_label) }}" />
            </div>
        ...
        <div class="field">
            ...
            <textarea name="features_text">{{ old('features_text', is_array($plan->features) ? implode("\n", $plan->features) : '') }}</textarea>
        </div>

        <div class="form-grid">
            <div class="field">
                <label>CTA Package Name</label>
                <input type="text" name="cta_package_name" value="{{ old('cta_package_name', $plan->cta_package_name) }}" />
            </div>

            <div class="field">
                <label>CTA Package Price</label>
                <input type="text" name="cta_package_price" value="{{ old('cta_package_price', $plan->cta_package_price) }}" />
            </div>
        </div>
