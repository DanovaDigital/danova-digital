...
@section('title', 'Tambah Testimonial — Admin')
...
<div class="card">
    <div class="card-header">
        <div>
            ...
            <div class="muted">Data untuk section Testimonials</div>
        </div>
    ...
    <form method="POST" action="{{ route('admin.testimonials.store') }}" enctype="multipart/form-data">
        ...
        <div class="field">
            ...
            <div class="help">Avatar foto untuk testimonial card. Ukuran rekomendasi: 200x200px</div>
        </div>
